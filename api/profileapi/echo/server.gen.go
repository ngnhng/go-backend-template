...
type ServerInterface interface {
	...
	DeleteProfile(ctx echo.Context, id ProfileId) error
	// Get profile by ID
	// (GET /v1/profiles/{id})
	GetProfileById(ctx echo.Context, id ProfileId) error
	// Patch an existing profile
	// (PATCH /v1/profiles/{id})
	ModifyProfile(ctx echo.Context, id ProfileId) error
...
func (w *ServerInterfaceWrapper) ModifyProfile(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.ModifyProfile(ctx, id)
	return err
}
...
func (sh *strictHandler) DeleteProfile(ctx echo.Context, id ProfileId) error {
...
func (sh *strictHandler) ModifyProfile(ctx echo.Context, id ProfileId) error {
...
func (sh *strictHandler) UpdateProfile(ctx echo.Context, id ProfileId) error {
